		...
		<table class="nui-table-inner">
			...
			<tbody class="nui-table-body">
				<tr class="nui-table-row">
					<td class="nui-table-cell"><%=rs.get("advice_id")%></td>
					...
					%>
					<td class="nui-table-cell "><a class="nui-txt-link"
						href="advice_detail.jsp?advice_id=<%=rs.get("advice_id")%>&advice_state=<%=rs.get("advice_state")%>"
					...
					%><td class="nui-table-cell "><a class="nui-txt-link"
						href="advice_detail.jsp?advice_id=<%=rs.get("advice_id")%>&advice_state=<%=rs.get("advice_state")%>"
						id="_mail_link_1305_4843"><font style="color:gray;">详细</font>
					</a>
					</td>
					<%
						}
