...
<input type=button value="查询" title="查询" class="tiaojianbutton" style="width:50;" onclick='f_r()' />
<div class='scrolldiv' 
...
<ul>
				...
				<%=station.get("station_desc").length()>12?station.get("station_desc").substring(0, 12)+"…":station.get("station_desc")%>
					</a>
					</li>
					<%}%>
</ul>
 ...
 <div class="frame-main-content" style="left:0; top:0;position: static;" >
 		<div class="nt">
	      <p class="tiaojiao-p">
	         	 均值类型:
                       <select name='rpt_data_table' id='rpt_data_table' onchange=f_submit() class="selectoption" >
 ...
 <iframe id='frm_station_id' name='frm_station' src='../commons/empty.jsp' width=100%  frameborder=0  scrolling="auto"></iframe>
...
function f_submit(){
 ...
 if(screen.height>=1024){
	  document.getElementById("frm_station_id").height=800;
	}else if(screen.height>=900  && screen.height<1024 ){
	  document.getElementById("frm_station_id").height=680;
	}else if(screen.height>=800  && screen.height<900 ){
	  document.getElementById("frm_station_id").height=580;
	}else if(screen.height>=768  && screen.height<800 ){
	  document.getElementById("frm_station_id").height=540;
	}else if(screen.height>=720  && screen.height<768 ){
	  document.getElementById("frm_station_id").height=500;
	}
</script>
