...
<form name=form1 method=post action="jdkhjg_bom.jsp" target='frm_zw_list'>
       ...
       <table border=0 cellspacing=0>
          <tr>
              <td> 
                      ...
                      地区:<select name=area_id  onchange=f_r()  class="search" style="width: 120px"><%=w.get("areaOption")%></select>
