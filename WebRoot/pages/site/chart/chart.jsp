...
String s = null;
String cols="station_id,station_name,chart_type,infectant_id,date1,date2,hour1,hour2,date3,hour3,refresh_time,real_flag,row_num,date_format,date_axis_fix_flag,bar,flag_3d,h,w,view_flag,chart_form,sh_flag_select";
...
if(f.eq(data_table,"t_monitor_real_ten_minute")){type="minute";}
//f.sop(type);
if(type==null){type="";}
