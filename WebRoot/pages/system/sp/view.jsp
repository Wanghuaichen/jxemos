...
<td class=left >
<input style="width:300px" type=text name=station_desc value="<%=b.get("station_desc")%>"></td>
</tr>
...
<tr>
<td class='tdtitle' style="width: 300px">设备编号</td>
<td class=left >
<input type=text name=sb_id value="<%=b.get("sb_id")%>" style="width:300px"></td>
</tr>
...
<td class='tdtitle'></td>
<td class=left>
<input type=submit value="保存" class="tiaojianbutton">

<input type=button value="返回" onclick=history.back()  class="tiaojianbutton">
