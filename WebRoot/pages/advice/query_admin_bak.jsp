...
.btn3{width:80px; height:23px; line-height:23px;  background:url(<%=request.getContextPath() %>/images/common/btn1.gif) no-repeat; border:none; text-align:center; }
</style>
</head>
<body >
<form name="form1" action="query_admin.jsp" method="post">
 <div class="fieldArea">
    <fieldset>
    <legend>查询</legend>
    <div class="selarea">
     <div class="item item1">
       <label>意见状态：</label>
		  ...
		  <label>时间：</label>
		<input type="text" name="date1" value="<%=date1 %>" readonly="readonly" onclick="new Calendar().show(this);">
		<input type="text" name="date2" value="<%=date2 %>" readonly="readonly" onclick="new Calendar().show(this);">
		<input type="submit" value="查询" title="查询" class="btn3 button">
    </div>
    </fieldset>
    </div>
...
<table border=0 width=100% cellspacing="1">
    ...
    <tr align="center" bgcolor="#FFFFFF">
    	...
    	<td class="black12_lh24"><a href="advice_detail.jsp?advice_id=<%=rs.get("advice_id") %>"><font style="color:red">详细</font></a></td>
    </tr>
    <%
    	}
    %>
