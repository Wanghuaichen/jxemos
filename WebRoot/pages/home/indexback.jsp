...
<table style='width:100%;height:100%' border=0 cellspacing=0>
  ...
  <tr>
    <td height="48" valign="bottom" background="./img/index_top_bg.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="550" align="left"><img src="./img/index_logo.jpg" width="450" height="48" /></td>
        <td valign="bottom" style="padding-right:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td ><table id="topTable" width="<%=b.get("wh") %>" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="90" align="center" style="display:<%=b.get("10140") %>" valign="bottom" class="nav_bg02"  >
                ...
                <td width="90" align="center" style="display:<%=b.get("10141") %>" valign="bottom" class="nav_bg02" >
  ...
  <tr>
    <td height="32" background="./img/index_nav_bg.jpg"><table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <div id='menu_zh' style='display:yes;'><table><tr>
        	<td style="color:white;display:<%=b.get("10132") %>"><a href='../real_data/index.jsp' id="sssj" class='yellow12_nav' target='frm_home_main'  onclick="f_menu_now('综合-->实时数据','1','sssj')">实时数据</a>│</td>
        	<td style="color:white;display:<%=b.get("10134") %>"><a href='../warn/' class='white12_nav' id="bjsj" target='frm_home_main'  onclick="f_menu_now('综合-->报警数据','1','bjsj')">报警数据</a>│</td>
        	<td style="color:white;display:<%=b.get("10135") %>"><a href='../fx/fx_home.jsp?action_flag=0' id="sjfx" class='white12_nav' target='frm_home_main' onclick="f_menu_now('综合-->数据分析','1','sjfx')">数据分析</a>│</td>
        	<td style="color:white;display:<%=b.get("10136") %>"><a href='..//fx/query/data.jsp?sh_flag=0' id="sjcx" class='white12_nav' target='frm_home_main' onclick="f_menu_now('综合-->数据查询','1','sjcx')">数据查询</a>│</td>
        	<td style="color:white;display:<%=b.get("10137") %>"><a href='<%=report_url%>?sh_flag=0' id='zlbb' class='white12_nav' target='frm_home_main' onclick="f_menu_now('综合-->总量报表','1','zlbb')">总量报表</a>│</td>
        	<td style="color:white;display:<%=b.get("10133") %>"><a href='../report/index_new.jsp?sh_flag=0' id='qtbb' class='white12_nav' target='frm_home_main' onclick="f_menu_now('综合-->其它报表','1','qtbb')">其它报表</a>│</td>
        	<td style="color:white;display:<%=b.get("10139") %>"><a href='<%=sp_url%>' class='white12_nav' target='new' id='sp' onclick="f_menu_now('综合-->视频','1','sp')">视频</a>│</td>
        </tr></table>
</div>

<div id='menu_advice' style='display:none;'><table><tr>
           <td style="color:white;display:<%=b.get("10142") %>"><a href='../advice/advice.jsp' id='yjfk' class="white12_nav" target='frm_home_main' onclick="f_menu_now('意见反馈-->意见反馈','4','yjfk')">意见反馈</a>│</td>
           <td style="color:white;display:<%=b.get("10143") %>"><a href='#' class="white12_nav" id='yjcx' onclick="f_right('<%=session.getAttribute("user_name") %>');f_menu_now('意见反馈-->意见查询','4','yjcx')">意见查询</a></td>
         </tr></table></div>
         <div id='menu_sh' style='display:none;'>
         <table><tr>
           <td style="color:white;display:<%=b.get("10145") %>">
           <a href='../sh_new/search/w.jsp' id='ycsjcx' class="white12_nav" target='frm_home_main' onclick="f_menu_now('审核-->异常数据查询','5','ycsjcx')">异常数据查询</a>│  </td>
           <td style="color:white;display:<%=b.get("10146") %>">
           <a href='../sh_new/index.jsp' target='frm_home_main' class="white12_nav" id='sjsh' onclick="f_menu_now('审核-->数据审核','5','sjsh')">数据审核</a>│ 
          </td>
           <td style="color:white;display:<%=b.get("10147") %>">
         <a href='../sh_new/search/hz.jsp' class='white12_nav' target='frm_home_main' id='shhz' onclick="f_menu_now('审核-->审核汇总','5','shhz')">审核汇总</a>│ 
         </td>
          <td style="color:white;display:<%=b.get("10147") %>">
         <a href='../sh_new/search/csshsj.jsp' class='white12_nav' target='frm_home_main' id='csshsh' onclick="f_menu_now('审核-->重算审核后数据','5','csshsh')">重算审核后数据</a>│ 
         </td>
         <td style="color:white;display:<%=b.get("10147") %>">
         <a href='../log/log_query.jsp' class='white12_nav' target='frm_home_main' id='hsrz' onclick="f_menu_now('审核-->审核日志','5','hsrz')">审核日志</a>
         </td>
          <%-- 
          <td style="color:white;display:<%=b.get("10147") %>">
         <a href='../system/station/q_form.jsp' class='white12_nav' target='frm_home_main' id='zwgl' onclick="f_menu_now('审核-->单独设置报警值','5','zwgl')">单独设置报警值</a>│ 
         </td>
          <td style="color:white;display:<%=b.get("10147") %>">
         <a href='../system/station/infectant/pl_q.jsp' class='white12_nav' target='frm_home_main' id='plszbjz' onclick="f_menu_now('审核-->批量设置报警值','5','plszbjz')">批量设置报警值</a>
         </td>
         --%>
         </tr></table>
          </div>
