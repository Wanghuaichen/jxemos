...
<form name=form1 method=post action='xchc_list.jsp' target="frm_zw_list">

<table style='width:100%;height:100%' border=0 cellspacing=0>
<tr class=title> 
   <td style="font-size: 16px;text-align: center">现场核查历史记录</td>
</tr>
  <tr class=title> 
      <td>
           从:
         ...
         状态:<select name=hcjl  onchange=f_r()  class="search" style="width: 120px">
