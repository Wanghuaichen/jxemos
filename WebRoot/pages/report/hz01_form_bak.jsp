...
<body scroll=no onload=form1.submit() style="background-color: #f7f7f7">
...
<input class='date' name='date' id='date' value='<%=StringUtil.getNowDate()%>' onclick="new Calendar().show(this);">
...
<iframe name="q"  width=100% height=400px  frameborder="0"  style="border:0px" allowtransparency="true">
</iframe>
