...
<form name=form1 method=post action='bdjc_list.jsp' target="frm_zw_list">

<table style='width:100%;height:100%' border=0 cellspacing=0>
<tr class=title> 
   <td style="font-size: 16px;text-align: center">比对监测历史记录</td>
</tr>
  <tr class=title> 
      <td>
           从:
         ...
         状态:<select name=bdjg  onchange=f_r()  class="search" style="width: 120px">
