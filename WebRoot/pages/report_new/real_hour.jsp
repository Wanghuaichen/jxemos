...
<%
    try{
      ...
      ReportUpdate.real_hour(request);
...
<div style="float:left;width:100%;"><center><font style="font-weight:bold;font-size;14px"><%=w.get("date1") %>至<%=w.get("date2") %>小时数据报表</center></div>
