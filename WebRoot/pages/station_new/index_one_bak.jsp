...
<%
    ...
    if(f.eq(station_type,"1") || f.eq(station_type,"2") ){rpt_display = "yes";}
...
<input type=hidden name='show_btn_flag' value='0'><%--是否显示保存按钮--%>
...
<input type=hidden name='g_cols' value='val05,val06,val07,val04,val09,val11'>
  ...
  <div class="rightCon">
        ...
        <!--
         ...
         <input type='button' value='曲线' onclick='f_chart()' class=btn>
                   ...
                   <ul>
                 		<li><a href="#" id='menu0' onclick="f_data()">数据</a></li>
                 		<li style="display:<%=rpt_display %>;"><a href="#" id='menu2' onclick="f_rpt()">报表</a></li>
                 		<li><a href="#" id='menu1' onclick="f_chart()">曲线</a></li>
                 		
                 		<li><a href="#" id='menu3' onclick="f_sp()">视频</a></li>
                 		<li style="display:none;"><a href="#" id='menu4' onclick="f_ctl()">远程控制</a></li>
                 		<li><a href="#" id='menu5' onclick="f_info()">属性</a></li>
                 		<li style="display:none;"><a href="#" id='menu6' onclick="f_wry()">污染源信息</a></li>
                 		<li><a href="#" id='menu7' onclick="f_bz()">备注</a></li>
                 	</ul>
                   </div>
                   ...
                   <div class="view2">
                       ...
                       <select name='data_table' id='data_table' onchange='f_btn();f_submit()'>
                         ...
                         <option value='t_monitor_real_month'>月汇总数据</option>
                       		...
                       		<div class="item">
                        <select name='rpt_data_table' id='rpt_data_table' onchange=f_submit() >
                         ...
                         --%><option value='t_monitor_real_month'>月汇总数据</option>
									...
									<input type=hidden name='data_type' id='data_type' value='normal' />
                       <select name='infectant_id' id='infectant_id' onchange='infectant_submit()'>
                        ...
                        <%}%>
                       		...
                       		<div class="item">
                       <input type='text'  name='date1' id='date1' value='<%=w.get("date1")%>' onclick="new Calendar().show(this);" />
                       <select name=hour1 id='hour1' >
                       <%=w.get("hour1Option")%>
                       </select>
                       		</div>
                       		<div class="item">
                       <input type='text' name='date2' id='date2' value='<%=w.get("date2")%>' onclick="new Calendar().show(this);" />
                       <select name=hour2 id='hour2' >
                       <%=w.get("hour2Option")%>
                       </select>
                       		</div>
                       		<div class="item">
                       <input type='text'  name='date3' id='date3' value='<%=f.today()%>' onclick="new Calendar().show(this);" />
                       ...
                       <select name='sh_flag_select'  id='sh_flag_select' onchange="sh_flag_check(this.value)">
                              <option value="0">原始数据</option>
						             <option value="1">审核数据</option>
                        </select>
                        	</div>
                        	<div class="item">
                       <input type='button' value="查看" class="btn1"  id='btn_view' onclick='f_view()' />
                            </div>
                            <%--<div class="item">
