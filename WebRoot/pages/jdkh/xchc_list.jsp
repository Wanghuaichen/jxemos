  ...
  <%} %>
    <tr>
      <td class=right colspan=8>
         <input type="checkbox" id="xchcs_id" onclick="checkall(this.form,this)"/><span class="span">以上全选</span>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button"  class="btn" onclick="YN_delete(this.form)" value="删除"/>
