...
<td style='height:20px'>
  ...
  <option value='./nb/01_form.jsp'>脱机统计报表
  <option value='./nb/02_form.jsp'>污染源在线监测日报表
  <option value='./std/index.jsp'>污染源废水烟气报表
  <option value='./area_report/form.jsp'>污染源废水烟气地区报表
 
  
 
  <option value='../fx/report/air.jsp'>空气日报
  <option value='../fx/report/water.jsp'>水质周报
  <option value='./hz01_form.jsp'>污染源脱机联机报表
  ...
  <option value='./fy/03_form.jsp?station_type=1'>故障数据审核
    ...
    <option value='./fy/02_form.jsp?station_type=1'>在线监控企业污染物排放统计汇总月报表
      ...
      <option value='./fy/05_form.jsp?station_type=1'>流量日报
<option value='./fy/06_form.jsp?station_type=1'>cod超标月报表
  ...
  <option value='./sx/05_form.jsp?station_type=2'>废气在线监测点SO2、Nox、烟尘排放in浓度分段统计排放统计报表
  
 <option value='./sx/06_form.jsp?station_type=1'>废水在线监测点完好率统计报表
 <option value='./sx/07_form.jsp?station_type=2'>废气在线监测点完好率统计报表
  
 <option value='./sx/08_form.jsp?station_type=1'>废水在线监测点完好率统计报表2
 <option value='./sx/09_form.jsp?station_type=2'>废气在线监测点完好率统计报表2
