...
<%
  ...
  station_id = request.getParameter("station_id");
     ...
     cnum=3;
      ...
      sql = "select * from t_cfg_station_info where station_type='"+station_type+"' and area_id like '"+area_id+"%' ";
      ...
      if(f.empty(sp_ip)){throw new Exception("请设置视频IP");}
      ...
      sp_td=(String)row.get("sp_channel");
      //if(StringUtil.isempty(sp_td)){continue;}
      if(StringUtil.isempty(sp_td)){throw new Exception("请设置通道号");}
      ...
      for(j=0;j<cnum;j++){
      s = sp_ip+","+sp_port+","+tds[j]+",0,"+sp_user+","+sp_pwd+",101,";
...
<HTML>
	...
	<body onLoad="MM_preloadImages('images/sp_ico_up0.png','images/sp_ico_base0.png','images/sp_ico_left0.png','images/sp_ico_right0.png');" leftMargin="0" onunload="StopPlay();" topMargin="0" MS_POSITIONING="GridLayout"  onunload="f_stopall()">
					...
					<td style="width:30%;align:left;text-align:center;valign:top" valign="top" id="tdControl">
						...
						<div id="control33" style="valign:top">
							...
							-->
								...
								<select size=18 style="width:270px" onclick=show_sp(this)>
								<%=spOption%>
