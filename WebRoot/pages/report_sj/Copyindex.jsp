 ...
 <td class="right">
                 <div class="rightCon">
                   ...
                   <div class="item">
                    ...
                    <div class="item">
                            从:
                       <input type='text' class='input' name='date1' id='date1' value='<%=w.get("date1")%>' onclick="new Calendar().show(this);" />
                      到:
                       <input type='text' class='input' name='date2' id='date2' value='<%=w.get("date2")%>' onclick="new Calendar().show(this);" />
                    </div>
